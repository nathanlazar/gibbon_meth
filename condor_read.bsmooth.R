par_read.bsmoothDirRaw <- function(dir, seqnames = NULL, keepCycle = FALSE, keepFilt = FALSE,
...
#####################################################################################################
    ...
    # Fire up HTCondor jobs to read each file
    #########################################
    
    # Save dir list for Condor
    save(allChrFiles, file='allChrFiles.dat')
...
par_read.bsmooth <- function(dirs, sampleNames = NULL, seqnames = NULL, returnRaw = FALSE,
